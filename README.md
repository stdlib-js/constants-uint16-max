...
```javascript
import UINT16_MAX from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint16-max@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-uint16-max/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/constants-uint16-max/actions/workflows/test.yml?query=branch:v0.2.0
